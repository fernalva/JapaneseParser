...
// Type of error: **
// Done by: ** 
void syntax_error1(string saved_l, tokenTypes token_type)
{
  cout << "SYNTAX ERROR: expected " << token_type << " but found " << saved_l;
  exit(1);
}
// Type of error: **
// Done by: **
void syntax_error2(string saved_l, tokenTypes expected)
{
  cout << "SYNTAX ERROR: unexpected " << saved_l << " found in " << expected;
  exit(1);
}
